...
class PopupDientes extends Component {
    ...
    render() {
        ...
        return (
                <Modal  show={this.props.propsShowDienteModal} onHide={this.props.funcionCloseDienteModal}  >
                        <Modal.Header style={{ backgroundColor:"#dbdbdb", color:"#000"}} closeButton>
                            <Modal.Title>DIENTES PERMANENTES</Modal.Title>
                        </Modal.Header>
                        <Modal.Body>
                        ...
                        <Row className="justify-content-md-center">
                            <Col md={10}>
                                <Form>
                                    { this.props.funcionRenderDientes()}
                                </Form>
                                ...
                                <Button variant = "info" size="sm" onClick={this.props.funcionCloseDienteModal}>Confirmar</Button>
                            </Col>
                </Row>
...
export default withRouter(PopupDientes)