...
class PopupDientesTemporarios extends Component {
    ...
    render() {
        ...
        return (
                <Modal  show={this.props.propsShowTemporariosModal} onHide={this.props.funcionCloseTemporariosModal}  >
                        <Modal.Header style={{ backgroundColor:"#dbdbdb", color:"#000"}} closeButton>
                            <Modal.Title>Dientes Temporarios</Modal.Title>
                        </Modal.Header>
                        <Modal.Body>
                        ...
                        <Row className="justify-content-md-center">
                            <Col md={10}>
                                <Form>
                                    { this.props.funcionRenderDientesTemporarios()}
                                </Form>
                                ...
                                <Button variant = "info" size="sm" onClick={this.props.funcionCloseTemporariosModal}>Confirmar</Button>
                            </Col>
                </Row>
...
export default withRouter(PopupDientesTemporarios)