...
class ProductoHistorico extends Component {
    state={
        // fechaNumero:'',
        clienteNombre:'',
        clienteCodigo:0,
    ...
    guardar=()=>{
        ...
        if(this.state.moviClienteEditarId) {
            ...
            && this.state.moviProcedimientoDescripcion!=''
                ...
                // console.log('DESCRIPCION:',this.state.seleccionados)
                // console.log('PRODUCTONOMBRE:',this.state.moviProductoNombre)
            ...
            <div>
                 <Form>
                    ...
                    <Row style = {{textAlign : "center", backgroundColor:"#dbdbdb", paddingTop:5}}>
                         <Col md={8} sm = {12} xs = {12} ><h4>HISTORICO</h4></Col>
                         <Col md={4} sm = {4} xs = {4} ><Button variant = "info" size="sm"  onClick={this.limpiarCampos}>Limpiar Filtros</Button></Col>
                    ...
                    <Row>
                        ...
                        <Col md={4} sm = {12} xs = {12}>
                                ...
                                {/* <Button variant = "info" size="sm"  onClick={this.limpiarCampos}>Limpiar Campos</Button>{' '} */}
                                ...
                                <Table id = "tablaVentas" striped bordered hover size="sm" >
                                            <thead>
                                                ...
                                                <th>{this.state.mostrarFiltro==true?<Form.Control size="sm" type="text" textAlign="center" placeholder="Mes" name="filtroMoviPeriodoMes" value = {this.state.filtroMoviPeriodoMes} onChange={this.capturarTecla} />:null}</th>
                                                    ...
                                                    {/* <th><Button style={{fontSize:"11px"}} variant = "info" size="sm"  onClick={this.limpiarCampos}>Limpiar Filtros</Button></th> */}
...
export default  withRouter(ProductoHistorico)
