...
class ProductoVenta extends Component {
    ...
    componentDidMount(){
        ...
        // this.obtenerImagenesTemporales()
        // console.log('listaImagenesProvisorias=',this.state.listaImagenesProvisorias)
        // this.calcularEdad()
    }
...
manejarImagenes =()=>{
    ...
    //     listaImagenesTemporal.forEach((dato)=>{
    //     db.collection('imagenesfinales').add({
    //         id : dato.id,
    //         ...dato,
    //         imagenNumeroFao : this.state.moviNumeroFao,
...
obtenerClientes =()=>{
    ...
    .then((clientes)=>{clientes.forEach((cliente)=>{listaClientesTemporal.push({
        ...
        // console.log('listaClientesTemporal:',listaClientesTemporal)
    })
    .catch((error)=>{
        alert(error)
    })
