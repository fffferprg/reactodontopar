...
import ProductoProduccion from './vistas/producto/ProductoProduccion';
        ...
        <Container>
         {this.state.usuarioLogeado== true? <Menu 
          ...
          <Switch>
              ...
              {this.state.rolesUsuarios.includes('Ventas')?<PrivateRoute exact path="/productos/ventas" component={ProductoVentaCopy2} usuarioLogeado={this.state.usuarioLogeado} />:null}
